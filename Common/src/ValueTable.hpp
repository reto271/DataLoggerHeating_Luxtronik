...
//  {  13, /*ID_WEB_Temperatur_TRL_ext*/        "Rücklauftemperatur im Trennspeicher",                                 10, "°C"},        //, 10 /* ??? War soeben 50 */ },                          -> deactivate
...
//  {  21, /*ID_WEB_Temperatur_TFB1*/           "Mischkreis 1 Vorlauftemperatur",                                      10, "°C"},        //, 10 /* 0..102.3 */},   // Was ist das für ein Wert?                          -> deactivate
//  {  22, /*ID_WEB_Sollwert_TVL_MK1*/          "Mischkreis 1 Vorlauf-Soll-Temperatur",                                10, "°C"},        //, 10 /* 0..102.3 */},   // Was ist das für ein Wert?                          -> deactivate
//  {  23, /*ID_WEB_Temperatur_RFV*/            "Raumtemperatur Raumstation 1",                                        10, "°C"},        //, 10 /* 0..102.3 */},   // Was ist das für ein Wert?                          -> deactivate
//  {  24, /*ID_WEB_Temperatur_TFB2*/           "Mischkreis 2 Vorlauftemperatur",                                      10, "°C"},        //, 10 /* 0..102.3 */},   // Was ist das für ein Wert?                          -> deactivate
//  {  25, /*ID_WEB_Sollwert_TVL_MK2*/          "Mischkreis 2 Vorlauf-Soll-Temperatur",                                10, "°C"},        //, 10 /* 0..102.3 */},   // Was ist das für ein Wert?                          -> deactivate
//  {  26, /*ID_WEB_Temperatur_TSK*/            "Fühler Solarkollektor",                                               10, "°C"},        //, 10 /* 0..102.3 */},   // Was ist das für ein Wert?                          -> deactivate
//  {  27, /*ID_WEB_Temperatur_TSS*/            "Fühler Solarspeicher",                                                10, "°C"},        //, 10 /* 0..102.3 */},   // Was ist das für ein Wert?                          -> deactivate
//  {  28, /*ID_WEB_Temperatur_TEE*/            "Fühler externe Energiequelle",                                        10, "°C"},        //, 10 /* 0..102.3 */},   // Was ist das für ein Wert?                          -> deactivate
...
//  {  36, /*ID_WEB_SWTin_Eingang*/             "Schwimmbadthermostat",                                                 0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
...
//  {  40, /*ID_WEB_MA1out_Ausgang*/            "Mischkreis 1 Auf",                                                     0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
//  {  41, /*ID_WEB_MZ1out_Ausgang*/            "Mischkreis 1 Zu",                                                      0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
...
//  {  45, /*ID_WEB_VD2out_Ausgang*/            "Verdichter 2",                                                         0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
...
//  {  50, /*ID_WEB_ZW3SSTout_Ausgang*/         "Zusatzheizung 3",                                                      0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
//  {  51, /*ID_WEB_FP2out_Ausgang*/            "Pumpe Mischkreis 2",                                                   0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
//  {  52, /*ID_WEB_SLPout_Ausgang*/            "Solarladepumpe",                                                       0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
//  {  53, /*ID_WEB_SUPout_Ausgang*/            "Schwimmbadpumpe",                                                      0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
//  {  54, /*ID_WEB_MZ2out_Ausgang*/            "Mischkreis 2 Zu",                                                      0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
//  {  55, /*ID_WEB_MA2out_Ausgang*/            "Mischkreis 2 Auf",                                                     0,  "-"},        //, 1 /* Binary value */ },                          -> deactivate
