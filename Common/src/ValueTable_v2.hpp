...
// *INDENT-OFF*
const ValueEntry_v2 ValueTableDecode_v2[] = {
...
const uint32_t FILE_Version_v2 = 2;
const uint32_t FILE_SizeOfHeader_v2 = 3;
const uint32_t FILE_NrDataEntries_v2 = sizeof(ValueTableDecode_v2) / sizeof(ValueEntry_v2);
